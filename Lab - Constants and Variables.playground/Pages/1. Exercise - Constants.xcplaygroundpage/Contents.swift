...
print(friends)
    ...
    /*Now assume you go through and remove friends that aren't active on social media. Attempt tp update your friends constant to a lower number than it currently is. Observe what happens and then move to th enext step*/
